...
const COLORS = ['#84749f', '#9b8db1', '#b2a5c4', '#6ea2e6', '#8ab6ec', '#a6c9f2'];
  ...
  return (
    <div className="w-full flex flex-col min-h-[calc(100vh-64px)] bg-transparent">
      ...
      <div className="bg-white border-b border-gray-200 h-16 flex items-center px-6 shadow-sm">
        <Link to="/" className="flex items-center text-slate-500 hover:text-[#84749f] transition-colors">
                  ...
                  <table className="w-full text-left text-sm">
                    <thead>
                      <tr className="bg-slate-50 border-b border-gray-100">
                        <th className="px-4 py-3 font-semibold text-slate-600 uppercase tracking-wider text-xs">School / Category</th>
                        <th className="px-4 py-3 font-semibold text-slate-600 uppercase tracking-wider text-xs text-right">Total</th>
                      </tr>
                    </thead>
