...
const MainNav = () => {
  ...
  return (
    <div className="bg-white w-full shadow-sm border-b border-gray-100 sticky top-0 z-50">
          ...
          <div className="hidden xl:block">
            {isAuthenticated ? (
              <button
                ...
                className={`bg-[#d60000] hover:bg-[#b30000] text-white px-4 py-2 rounded flex items-center justify-center space-x-2 font-medium transition ${isLoggingOut
      ...
      {/* Overlay Backdrop */}
      <div
        className={`xl:hidden fixed inset-0 bg-black/60 backdrop-blur-xs z-[60] transition-opacity duration-300 ease-in-out ${isMenuOpen
        ...
        <div className="p-4 border-t border-gray-100 bg-white shrink-0 shadow-md sticky bottom-0 z-[80]">
          {isAuthenticated ? (
            <button
              ...
              disabled={isLoggingOut}
              className={`bg-[#d60000] hover:bg-[#b30000] text-white px-4 py-3 rounded-lg flex items-center justify-center space-x-2 font-semibold w-full transition shadow-sm ${isLoggingOut
                ? 'opacity-75 cursor-not-allowed'
                : 'cursor-pointer'
                }`}
            >
