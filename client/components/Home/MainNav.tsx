        ...
        <div className='bg-white w-full shadow-sm border-b border-gray-100'>
            <div className='w-full px-4 md:px-12 py-3 flex items-center justify-between'>
                <div className='flex items-center space-x-6'>
                    <Image src="/logo1.png" alt="College Logo" width={220} height={60} className="object-contain" />
                    <Image src="/logo2.jpg" alt="NAAC Logo" width={110} height={60} className="object-contain hidden md:block" />
                </div>
